...
import { product_details } from "../store/Reducers/homeReducerSlice";
import {
  add_to_card,
  add_to_wishlist,
  messageClear,
} from "../store/Reducers/cardReducerSlice";
...
export default function Details() {
      ...
      const obj = [
        {
          ...
          price:
            quantity * (price - Math.floor((price * product.discount) / 100)),
          products: [
            {
              quantity,
              productInfo: product,
  ...
  return (
    <div>
          ...
          <div className="grid grid-cols-2 md-lg:grid-cols-1 gap-8">
            ...
            <div className="flex flex-col gap-5">
              ...
              <div className="text-slate-600">
                ...
                <p className="text-green-800 py-1 font-bold">Shop Name: {product.shopName}</p>
              </div>
              ...
              <div className="flex gap-3">
                {product.stock ? (
                  <button onClick={buynow} className="px-8 py-3 h-[50px] cursor-pointer hover:shadow-lg hover:shadow-green-500/40 bg-[#059473] text-white">
                    Buy Now
                  </button>
                ) : (
                  ""
      ...
      <section>
        <div className="w-[85%] md:w-[80%] sm:w-[90%] lg:w-[90%] h-full mx-auto pb-16 mt-3">
              ...
              <div className="pr-4 md-lg:pr-0">
                <div className="grid grid-cols-2">
                  <button
                    ...
                    className={`py-1 px-5 cursor-pointer hover:shadow-lg hover:shadow-green-500/40 hover:bg-[#059473] hover:text-white ${
                      state === "reviews"
                ...
                <div>{state === "reviews" ? <Reviews product={product}/> : 
