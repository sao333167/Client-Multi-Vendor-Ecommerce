...
import { get_card_products,delete_card_product, messageClear,quantity_inc,quantity_dec } from "../store/Reducers/cardReducerSlice";
import toast from "react-hot-toast";

export default function Card() {
    const { userInfo } = useSelector((state) => state.auth);
    const { card_products,outofstock_products,price,successMessage,buy_product_item,
      shipping_fee,errorMessage
                          ...
                          <div key={i} className="w-full flex flex-wrap">
                            ...
                            <div className="flex justify-between w-5/12 sm:w-full sm:mt-3">
                              <div className="pl-4 sm:pl-0">
                                <h2 className="ftext-lg text-orange-500">
                              ...
                              <div className="flex gap-2 flex-col">
                                ...
                                <button onClick={() => dispatch(delete_card_product(pt._id))}  className="px-5 py-[3px] bg-red-500 text-white">
                                  Delete
                                </button>
                              </div>
                            </div>
