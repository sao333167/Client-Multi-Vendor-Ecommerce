...
import { place_order } from "../store/Reducers/orderReducerSlice";
...
export default function Shipping() {
  ...
  const inputHandle = (e) => {
   ...
   const save = (e) => {
      ...
      const placeOrder = () => {
        console.log('place order called', { res, state, userInfo });
                  ...
                  {res && (
                    <div className="flex flex-col gap-1">
                      ...
                      <p>
                        ...
                        <span>phone:{state.phone},address:{state.address} , province:{state.province}, city:{state.city}, area:{state.area}</span>
